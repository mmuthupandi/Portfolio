...
const ContactSection = () => {
    ...
    return (
        <div id="contact" className="min-h-screen bg-background-light dark:bg-background-dark w-full max-w-7xl mx-auto border-x border-gray-100 dark:border-gray-900 p-8 flex flex-col justify-center">
            <div className="space-y-8 min-h-screen flex flex-col justify-center items-center text-center">
                ...
                <div className="max-w-md w-full space-y-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 text-left">
                        <div className="space-y-2">
                            ...
                            <input type="email" id="email" required className="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all dark:text-white" />
                        </div>
                        <div className="space-y-2">
                            <label htmlFor="message" className="text-sm font-semibold dark:text-white">Message</label>
                            <textarea id="message" required className="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all dark:text-white min-h-[120px]"></textarea>
                        </div>
                        <MagneticButton type="submit" variant="primary" size="md" className="w-full font-bold py-4">
                            Send Message
                        </MagneticButton>
                    </form>
